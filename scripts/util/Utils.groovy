...
class Utils {
    static Position northWestOf(Area a) {
        return new Position(a.west, a.north)
    }

    static Position northEastOf(Area a) {
        return new Position(a.east, a.north)
    }

    static Position southWestOf(Area a) {
        return new Position(a.west, a.south)
    }

    static Position southEastOf(Area a) {
        return new Position(a.east, a.south)
    }
    
    static class MouseButton {
