...
public class OptWnd extends Window {
	...
	{ /* GENERAL TAB */
	    ...
	    (new CheckBox(new Coord(10, 250), tab, "Always show heartling names") {
		public void changed(boolean val) {
	    ...
	    (new CheckBox(new Coord(10, 280), tab, "Always show other kin names") {
		public void changed(boolean val) {
	    ...
	    (new CheckBox(new Coord(10, 310), tab, "Show smileys in chat") {
		public void changed(boolean val) {
       ...
       (new CheckBox(new Coord(10, 370), tab, "Enable auto speed") {
       public void changed(boolean val) {
